...
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=400&size=22&pause=1500&color=C7F284&center=true&vCenter=true&width=620&lines=AI+Researcher+%26+Engineer;Generative+AI+%C2%B7+Computer+Vision+%C2%B7+NLP;Building+systems+that+ship" alt="Karan Anchan — AI Researcher & Engineer" />
...
3D segmentation pipeline using UNETR on the BTCV dataset. HU-scaling on DICOM/NIFTI files, Dice-Cross Entropy loss for class imbalance.
**Result:** Mean Dice **0.82** across 13 organs.

#### 🗣️ [English-Hindi Neural Machine Translation](https://github.com/KaranAnchan/en-hi-nmt-transformer)
*PyTorch · Transformers · Gradio*

43M-parameter Transformer built from scratch (no `nn.Transformer`) on 500k AI4Bharat Samanantar pairs. Byte-level BPE, Noam schedule, length-normalized beam search, Gradio demo with cross-attention heatmaps.
**Result:** **BLEU 16.93 · chrF++ 41.58 · TER 71.41** (beam-4, held-out 5k test).

➡️ Full portfolio at **[karananchan.github.io](https://karananchan.github.io/)**
...
**[karananchan.github.io](https://karananchan.github.io/)** &nbsp;·&nbsp; **[kar.anchan02@gmail.com](mailto:kar.anchan02@gmail.com)**
